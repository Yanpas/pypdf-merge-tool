...
# pypdf_merge_tool.py
#
# A very simple, minimalist Python command-line tool for merging PDF files and creating bookmarks.

# Licensed under the GPL License v 3
# Original author, Nicholas Kim. Changes by Yan Pashkovsky
